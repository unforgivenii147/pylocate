...
def updatedb():
    ...
    parser = argparse.ArgumentParser(
        description='Update PyLocate database',
        prog='updatedb-py'
    )
    parser.add_argument(
        'paths',
        nargs='*',
        help='Paths to index (default: home and system paths)'
    )
    parser.add_argument(
        '--database',
        '-d',
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Find files by name using PyLocate database',
        prog='pylocate'
    )
    parser.add_argument(
        'pattern',
        nargs='?',
        help='Search pattern (supports * and ? wildcards)'
    )
    parser.add_argument(
        '--database',
        '-d',
    ...
    parser.add_argument(
        ...
        '-u',
        action='store_true',
        help='Update database before searching'
    )
